 ...
 */
final class Version20221017165839 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE recipe DROP ingredient_list, CHANGE cooking_time cooking_time INT DEFAULT NULL');
    }
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE recipe ADD ingredient_list LONGTEXT NOT NULL COMMENT \'(DC2Type:array)\', CHANGE cooking_time cooking_time TIME DEFAULT NULL COMMENT \'(DC2Type:time_immutable)\'');
    }
}
